...
export function LoginScreen({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (
        emailLower.includes("platform") ||
        emailLower.includes("superadmin")
      ) {
        onLogin({ role: "platform-admin", mustChangePassword: false });
      } else if (
        emailLower.includes("enduser") ||
        emailLower.includes("end-user") ||
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #0D1B2A 0%, #1B2A4A 50%, #00838F 100%)",
      }}
    >
      {/* Background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(0,188,212,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(0,188,212,0.04) 1px, transparent 1px)",
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-8">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #00BCD4, #00E5CC)",
                    ...
                    <div className="flex flex-col gap-1 mt-1">
                      {[
                        ...
                        >
                          ...
                          <span
                            className={`text-xs ${rule.valid ? "text-[#10B981]" : "text-[#F59E0B]"}`}
                          >
                            {rule.label}
                          </span>
                        </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {confirmPw.length > 0 && !passwordMatch && (
                    <p className="text-xs text-[#EF4444] flex items-center gap-1">
                      <AlertTriangle className="w-3 h-3" /> Passwords do not
                      match
                    </p>
                  )}
                </div>
            ...
            <CardContent className="p-8">
                ...
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    },
                    {
                      ...
                      hint: "Standard CMMS access",
                    },
                    {
                      label: "CMMS End User",
                      email: "enduser@hospital.com",
                      hint: "Ticket generation only",
                    },
                  ].map((demo) => (
                    <button
                      key={demo.email}
              ...
              <div className="mt-5 text-center">
                <p className="text-xs" style={{ color: "#64748B" }}>
                  Enterprise Healthcare Platform by{" "}
