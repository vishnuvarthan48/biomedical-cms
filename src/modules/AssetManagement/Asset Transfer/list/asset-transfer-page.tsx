...
const mockTransfers: TransferHeader[] = [
  {
    id: "ATR-001",
    transferNo: "ATR-2026-001",
    sourceOrg: "Apollo Hospital - Chennai",
    destOrg: "Apollo Hospital - Delhi",
    sourceLocation: "ICU - Block A",
    destLocation: "ICU - Building 2",
    requestedBy: "Dr. Arun Mehta",
    requestedDate: "2026-01-10",
    reason: "Surplus ventilators redeployed to Delhi ICU expansion",
    status: "Accepted",
    lineCount: 3,
    submittedAt: "2026-01-10",
    dispatchedAt: "2026-01-12",
  ...
  {
    id: "ATR-002",
    transferNo: "ATR-2026-002",
    sourceOrg: "Apollo Hospital - Delhi",
    destOrg: "Apollo Hospital - Bangalore",
    sourceLocation: "OT Complex",
    destLocation: "Surgical Ward",
    requestedBy: "Ramesh Kumar",
    requestedDate: "2026-01-18",
    reason: "OT equipment rotation per quarterly plan",
    status: "Dispatched",
    lineCount: 2,
    submittedAt: "2026-01-18",
    dispatchedAt: "2026-01-20",
    receivedAt: "",
    acceptedAt: "",
  ...
  {
    id: "ATR-003",
    transferNo: "ATR-2026-003",
    sourceOrg: "Apollo Hospital - Chennai",
    destOrg: "Apollo Hospital - Hyderabad",
    sourceLocation: "Biomedical Dept",
    destLocation: "Radiology",
    requestedBy: "Priya Sharma",
    requestedDate: "2026-02-01",
    reason: "X-ray machine relocation for new radiology wing",
    status: "Submitted",
    lineCount: 1,
  ...
  {
    id: "ATR-004",
    transferNo: "ATR-2026-004",
    sourceOrg: "Apollo Hospital - Bangalore",
    destOrg: "Apollo Hospital - Chennai",
    sourceLocation: "Emergency Ward",
    destLocation: "Emergency - Block B",
    requestedBy: "Dr. Vijay Rao",
    requestedDate: "2026-02-05",
    reason: "Emergency defibrillator reallocation",
    status: "Received",
    lineCount: 2,
    submittedAt: "2026-02-05",
    dispatchedAt: "2026-02-06",
  ...
  {
    id: "ATR-005",
    transferNo: "ATR-2026-005",
    sourceOrg: "Apollo Hospital - Hyderabad",
    destOrg: "Apollo Hospital - Delhi",
    sourceLocation: "Pathology Lab",
    destLocation: "Central Lab",
    requestedBy: "Sneha Patel",
    requestedDate: "2026-02-10",
    reason: "Blood analyzer upgrade swap between labs",
    status: "Rejected",
    lineCount: 1,
  ...
  {
    id: "ATR-006",
    transferNo: "ATR-2026-006",
    sourceOrg: "Apollo Hospital - Chennai",
    destOrg: "Apollo Hospital - Mumbai",
    sourceLocation: "NICU",
    destLocation: "NICU - Wing C",
    requestedBy: "Dr. Meera Nair",
    requestedDate: "2026-02-12",
    reason: "Neonatal incubator surplus redistribution",
    status: "Draft",
    lineCount: 4,
    submittedAt: "",
    dispatchedAt: "",
  ...
  {
    id: "ATR-007",
    transferNo: "ATR-2026-007",
    sourceOrg: "Apollo Hospital - Delhi",
    destOrg: "Apollo Hospital - Chennai",
    sourceLocation: "Dialysis Center",
    destLocation: "Nephrology - Floor 3",
    requestedBy: "Suresh Reddy",
    requestedDate: "2026-02-14",
    reason: "Dialysis machine fleet rotation",
    status: "Approved",
    lineCount: 3,
  ...
  {
    id: "ATR-008",
    transferNo: "ATR-2026-008",
    sourceOrg: "Apollo Hospital - Mumbai",
    destOrg: "Apollo Hospital - Hyderabad",
    sourceLocation: "Cardiac Cath Lab",
    destLocation: "Cardiac Ward",
    requestedBy: "Dr. Karthik Menon",
    requestedDate: "2026-01-25",
    reason: "Cardiac monitor redeployment",
    status: "Cancelled",
    lineCount: 1,
  ...
  {
    id: "ATR-009",
    transferNo: "ATR-2026-009",
    sourceOrg: "Apollo Hospital - Bangalore",
    destOrg: "Apollo Hospital - Mumbai",
    sourceLocation: "Physiotherapy",
    destLocation: "Rehab Center",
    requestedBy: "Anita Desai",
    requestedDate: "2026-02-08",
    reason: "Physiotherapy equipment consolidation",
    status: "Dispatched",
    lineCount: 5,
    submittedAt: "2026-02-08",
    dispatchedAt: "2026-02-10",
    receivedAt: "",
    acceptedAt: "",
  ...
  {
    id: "ATR-010",
    transferNo: "ATR-2026-010",
    sourceOrg: "Apollo Hospital - Hyderabad",
    destOrg: "Apollo Hospital - Bangalore",
    sourceLocation: "Pulmonology",
    destLocation: "Respiratory - ICU B",
    requestedBy: "Dr. Leela Rao",
    requestedDate: "2026-02-15",
    reason: "BiPAP machines for new respiratory ICU",
    status: "Submitted",
    lineCount: 2,
...
const assetLookup = equipmentList
  .filter((e) => e.status !== "Condemned")
  .map((e) => ({
    tag: e.id,
    name: e.name,
    serial: e.serial,
    model: e.manufacturer,
    category: e.category,
  }));
...
function TransferListView({
  ...
  const filtered = useMemo(() => {
    return transfers.filter((t) => {
      const matchView =
        viewMode === "outgoing" ? t.sourceOrg === myOrg : t.destOrg === myOrg;
      ...
      if (searchQuery.trim()) {
        ...
        return (
          ...
          t.sourceOrg.toLowerCase().includes(q) ||
          t.destOrg.toLowerCase().includes(q) ||
  ...
  const incomingPending = transfers.filter(
    (t) =>
      t.destOrg === myOrg &&
      ["Submitted", "Dispatched", "Received"].includes(t.status),
  ).length;
  const outgoingDrafts = transfers.filter(
    (t) => t.sourceOrg === myOrg && t.status === "Draft",
  ).length;
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-base text-muted-foreground mt-1">
            Transfer assets between organizations with full audit trail
          </p>
        </div>
      ...
      <div className="rounded-xl border border-[#00BCD4]/20 bg-[#00BCD4]/5 px-5 py-3 flex items-start gap-3">
        ...
        <div className="text-sm text-foreground leading-relaxed">
          <span className="font-bold">Asset Transfer Request (ATR).</span> Move
          registered assets from source org/location to destination. Asset
          ownership updates{" "}
          <span className="font-bold text-[#10B981]">
            only after destination accepts
          </span>
          . Status: Draft &rarr; Submitted &rarr; Approved &rarr; Dispatched
          &rarr; Received &rarr; Accepted.
        </div>
      </div>
        ...
        {(["outgoing", "incoming"] as const).map((mode) => (
          ...
          >
            ...
            {mode === "incoming" && incomingPending > 0 && (
              <span className="ml-1 w-5 h-5 rounded-full bg-[#3B82F6] text-white text-xs font-bold flex items-center justify-center">
                {incomingPending}
              </span>
            )}
            {mode === "outgoing" && outgoingDrafts > 0 && (
              <span className="ml-1 w-5 h-5 rounded-full bg-[#D97706] text-white text-xs font-bold flex items-center justify-center">
                {outgoingDrafts}
              </span>
            )}
          </button>
      ...
      <div className="relative max-w-xl">
        ...
        <Input
          placeholder="Search by transfer no, organization, requester..."
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        {[
          ...
          {
            label: "In Transit",
            value: transfers.filter((t) => t.status === "Dispatched").length,
            icon: Truck,
            color: "#F59E0B",
          },
          {
          ...
          {
            label: "Completed",
            value: transfers.filter((t) => t.status === "Accepted").length,
            icon: CheckCircle2,
            color: "#10B981",
          },
          {
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((t) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-5 text-foreground font-semibold text-sm max-w-[180px] truncate">
                        {t.sourceOrg}
                      </td>
                      <td className="py-4 px-5 text-foreground font-semibold text-sm max-w-[180px] truncate">
                        {t.destOrg}
                      </td>
                      <td className="py-4 px-5 text-sm text-muted-foreground max-w-[140px] truncate">
                        {t.sourceLocation}
                      </td>
                      <td className="py-4 px-5 text-sm text-muted-foreground max-w-[140px] truncate">
                        {t.destLocation}
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-48">
                              ...
                              <DropdownMenuItem className="gap-2 cursor-pointer">
                                <Printer className="w-4 h-4" /> Print Transfer
                                Note
                              </DropdownMenuItem>
                              <DropdownMenuItem className="gap-2 cursor-pointer">
...
function TransferForm({
  ...
  editTransfer: TransferHeader | null;
  onBack: () => void;
}) {
  ...
  const [sourceLocation, setSourceLocation] = useState(
    editTransfer?.sourceLocation || "",
  );
  const [destLocation, setDestLocation] = useState(
    editTransfer?.destLocation || "",
  );
  const [requestedDate, setRequestedDate] = useState(
    editTransfer?.requestedDate || new Date().toISOString().split("T")[0],
  );
  ...
  const canAcceptReject =
    isIncoming && ["Received", "Submitted"].includes(editTransfer.status);
  const [selectedForAccept, setSelectedForAccept] = useState<Set<string>>(
    new Set(),
  );
  const [rejectReason, setRejectReason] = useState("");

  const toggleSelect = (id: string) => {
    setSelectedForAccept((prev) => {
  ...
  const selectAll = () => {
    if (selectedForAccept.size === lines.length)
      setSelectedForAccept(new Set());
  ...
  const sourceLocOptions = (locationsByOrg[sourceOrg] || []).map((l) => ({
    value: l,
    label: l,
  }));
  const destLocOptions = (locationsByOrg[destOrg] || []).map((l) => ({
    value: l,
    label: l,
  }));
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            {isEdit && (
              <span
                className={cn(
                  "inline-flex px-3 py-1 rounded-full text-sm font-semibold",
                  statusColors[editTransfer.status],
                )}
              >
                {editTransfer.status}
              </span>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            {isEdit
              ? `Requested by ${editTransfer.requestedBy} on ${editTransfer.requestedDate}`
              : "Transfer registered assets between organizations"}
          </p>
        </div>
      </div>
      ...
      {isEdit && ["Submitted", "Dispatched"].includes(editTransfer.status) && (
        <div className="rounded-xl border border-[#F59E0B]/20 bg-[#F59E0B]/5 px-5 py-3 flex items-start gap-3">
          ...
          <div className="text-sm text-foreground leading-relaxed">
            <span className="font-bold">Assets in transit.</span> Ownership
            remains with{" "}
            <span className="font-bold text-[#00BCD4]">
              {editTransfer.sourceOrg}
            </span>{" "}
            until destination accepts. Physical custody is with
            logistics/carrier.
          </div>
        </div>
      )}
        ...
        <Card className="border border-border shadow-sm">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              {["Draft", "Submitted", "Dispatched", "Received", "Accepted"].map(
                (step, idx) => {
                  const stepOrder = [
                    "Draft",
                    "Submitted",
                  ...
                  const isRejected =
                    editTransfer.status === "Rejected" ||
                    editTransfer.status === "Cancelled";
            ...
            {(editTransfer.status === "Rejected" ||
              ...
              <div className="mt-4 flex items-center gap-2 px-4 py-3 rounded-lg bg-destructive/5 border border-destructive/20">
                ...
                <span className="text-sm font-semibold text-destructive">
                  Transfer {editTransfer.status.toLowerCase()}
                </span>
              </div>
            )}
          </CardContent>
      ...
      <div className="flex items-center gap-3">
        {(!isEdit || editTransfer.status === "Draft") && (
          <>
            <Button
              className="text-white border-0 text-sm font-semibold h-11 px-5"
              style={{
            ...
            <Button
              className="text-white border-0 text-sm font-semibold h-11 px-5 bg-[#2563EB] hover:bg-[#1D4ED8]"
              onClick={onBack}
            >
        ...
        {canAcceptReject && (
          <>
            ...
            <Button
              variant="outline"
              className="text-sm font-semibold h-11 px-5 text-destructive border-destructive/30 hover:bg-destructive/5"
              onClick={onBack}
            >
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <FormField label="Transfer No" required>
                <Input
                  className="h-11 bg-muted/30 font-mono font-semibold"
                  readOnly
                  value={
                    isEdit ? editTransfer.transferNo : "ATR-2026-011 (Auto)"
                  }
                />
              </FormField>
              <FormField label="Source Organization" required>
                <Input
                  className="h-11 bg-muted/30 font-semibold"
                  value={sourceOrg}
                  readOnly
                />
              </FormField>
              ...
              <FormField label="Expected Transfer Date" required>
                <Input
                  type="date"
                  className="h-11"
                  value={isEdit ? editTransfer.requestedDate : expectedDate}
              ...
              <FormField label="Requested By">
                <Input
                  className="h-11 bg-muted/30 font-semibold"
                  value={
                    isEdit ? editTransfer.requestedBy : "Arjun Kumar (Auto)"
                  }
                  readOnly
                />
              </FormField>
            ...
            <div className="mt-5">
              <FormField label="Reason / Remarks">
                <Textarea
                  ...
                  placeholder="Why are these assets being transferred?"
                  value={reason}
                ...
                {timeline.map((ev) => (
                  ...
                  >
                    <ev.icon
                      className={cn(
                        "w-5 h-5 shrink-0",
                        ev.date ? "text-[#00BCD4]" : "text-muted-foreground/40",
                      )}
                    />
                    <div>
                      ...
                      <p
                        className={cn(
                          ...
                          ev.date ? "text-foreground" : "text-muted-foreground",
                        )}
                      >
                        {ev.date || "Pending"}
                      </p>
      ...
      {canAcceptReject && (
        <div>
          <h3 className="text-base font-extrabold text-foreground mb-4 pb-3 border-b border-border flex items-center gap-2">
            <MessageSquare className="w-4 h-4 text-destructive" /> Rejection
            Reason (if rejecting)
          </h3>
          <Card className="border border-destructive/20 shadow-sm">
            <CardContent className="p-5">
              <Textarea
                className="min-h-[80px] border-destructive/20 focus:border-destructive"
      ...
      <div>
        <div className="flex items-center justify-between mb-5 pb-3 border-b border-border">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              {lines.length} asset(s) in this transfer
            </p>
          </div>
          <div className="flex items-center gap-3">
            {canAcceptReject && lines.length > 0 && (
              <Button
                ...
                onClick={selectAll}
              >
                {selectedForAccept.size === lines.length
                  ? "Deselect All"
                  : "Select All"}
              </Button>
            )}
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border bg-muted/30">
                      <th className="text-left py-3 px-4 font-bold text-foreground text-xs">
                        Asset Tag
                      </th>
                      <th className="text-left py-3 px-4 font-bold text-foreground text-xs">
                        Equipment Name
                      ...
                      <th className="text-right py-3 px-4 font-bold text-foreground text-xs">
                        Action
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {filteredAssets.map((a) => {
                      ...
                      return (
                        ...
                        >
                          <td className="py-2.5 px-4 font-mono font-bold text-[#00BCD4] text-xs">
                            {a.tag}
                          </td>
                          <td className="py-2.5 px-4 text-foreground text-xs font-semibold truncate max-w-[220px]">
                            {a.name}
                          </td>
                          ...
                          <td className="py-2.5 px-4 text-right">
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 px-3 text-xs font-semibold text-[#00BCD4]"
                              disabled={alreadyAdded}
                              onClick={() => addAsset(a.tag)}
                            >
          ...
          <Card className="border border-dashed border-border">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Click "Add Asset" to search and add registered assets for
                transfer
              </p>
            </CardContent>
          </Card>
                      ...
                      >
                        {canAcceptReject && (
                          <td className="py-4 px-4">
                            <Checkbox
                              checked={selectedForAccept.has(ln.id)}
                              onCheckedChange={() => toggleSelect(ln.id)}
                            />
                          </td>
                        )}
                        <td className="py-4 px-5 font-mono font-bold text-[#00BCD4] text-sm">
                        ...
                        <td className="py-4 px-5 text-foreground font-semibold text-sm max-w-[220px] truncate">
                          {ln.assetName}
                        </td>
                        <td className="py-4 px-5 font-mono text-sm text-muted-foreground">
                          {ln.serialNo}
                        </td>
                          ...
                          {!isViewOnly ? (
                            ...
                            <span
                              className={cn(
                                ...
                                conditionColors[ln.handoverCondition],
                              )}
                            >
                              {ln.handoverCondition}
                            </span>
                          )}
                        </td>
                        {(canReceive ||
                          ...
                          <td className="py-4 px-5">
                            {canReceive ? (
                              <SelectField
                                value={ln.receiverCondition || "Good"}
                                onChange={(v) =>
                                  setLines((prev) =>
                                    prev.map((l) =>
                                      l.id === ln.id
                              ...
                              <span
                                className={cn(
                                  "inline-flex px-3 py-1 rounded-full text-sm font-semibold border",
                                  conditionColors[ln.receiverCondition],
                                )}
                              >
                                {ln.receiverCondition}
                              </span>
                        ...
                        <td className="py-4 px-5">
                          {!isViewOnly ? (
                            <Input
                              ...
                              value={ln.accessories}
                              onChange={(e) =>
                                setLines((prev) =>
                                  prev.map((l) =>
                                    l.id === ln.id
                                      ? { ...l, accessories: e.target.value }
                                      : l,
                                  ),
                                )
                              }
                        ...
                        <td className="py-4 px-5">
                          <span
                            className={cn(
                              "inline-flex px-3 py-1 rounded-full text-sm font-semibold",
                              lineStatusColors[ln.lineStatus],
                            )}
                          >
                            {ln.lineStatus}
                          </span>
          ...
          <Card className="border border-dashed border-border hover:border-[#00BCD4]/30 transition-colors cursor-pointer">
            <CardContent className="p-10 text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Handover note, photos, approval documents (Max 10MB each)
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      {isEdit && editTransfer.status === "Accepted" && (
        <div className="rounded-xl border border-[#10B981]/20 bg-[#10B981]/5 px-5 py-3 flex items-start gap-3">
          ...
          <div className="text-sm text-foreground leading-relaxed">
            <span className="font-bold">Transfer Completed.</span> Asset
            ownership has been updated: Organization changed to{" "}
            <span className="font-bold text-[#00BCD4]">
              {editTransfer.destOrg}
            </span>
            , Location changed to{" "}
            ...
            . Depreciation continues unchanged per tenant policy. Immutable
        ...
        <p className="text-sm text-muted-foreground">
          ...
          {canAcceptReject && selectedForAccept.size > 0 && (
            <span className="ml-2 font-bold text-[#10B981]">
              {selectedForAccept.size} selected for accept
            </span>
          )}
        </p>
