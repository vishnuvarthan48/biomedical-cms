              ...
              <CardContent className="p-7">
                ...
                <div className="flex flex-col gap-1">
                  {cat.reports.map((r) => (
                    <button
                      key={r}
                      className="flex items-center justify-between px-4 py-3 rounded-lg text-sm font-medium text-foreground hover:bg-muted/50 transition-colors text-left group"
                    >
                      <span>{r}</span>
